...
export default {
  ...
  getCustomerOrder: `${WEBSITE}/api/saleOrder/getCustomerOrder`,

  // todo: 设置用户昵称与性别
  setUserNickName: `${WEBSITE}/api/right/setUserNickName`,

  // todo: 上传用户头像
  uploadUserHeadPic: `${WEBSITE}/api/right/uploadUserHeadPic`,

  // todo: 修改密码
  modifyPwd: `${WEBSITE}/api/right/modifyPwd`,

  // todo: 修改手机号
  changeMobile: `${WEBSITE}/api/right/changeMobile`,

  // todo: 上门门店地址
  allShopadd: `${WEBSITE}/api/right/getAllShop`
};
